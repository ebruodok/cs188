...
class ExactInference(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        # oldPos is the previous ghost position
        dist = DiscreteDistribution()
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        self.particles = []
        "*** YOUR CODE HERE ***"
        #mod by total number of positions on the board
        numPositions = len(self.legalPositions)
        self.particles = [self.legalPositions[i%numPositions] for i in range(self.numParticles)]
    ...
    def observeUpdate(self, observation, gameState):
        ...
        #PIAZZA HELPFUL: "for q6, use += when updating your distribution"
        dist = DiscreteDistribution()
...
class JointParticleFilter(ParticleFilter):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        # A correct implementation will weight and resample the entire list of
